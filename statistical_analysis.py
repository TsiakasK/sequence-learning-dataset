...
for index in [1]: 
	# datasets
	data = pd.read_csv('datasets/final_' + str(index) + '.csv', delimiter=' ')
	...
	plt.subplot(212)
	P1['engagement'].hist()
	plt.savefig('figures/engagement_over_performance_' + str(index) + '.png')
	plt.close()
	...
	L4['engagement'].hist()
	plt.xlim([0,1])
	plt.savefig('figures/engagement_per_levels_' + str(index) + '.png')
	plt.close()
	...
	plt.subplot(133)
	C2['engagement'].hist()
	plt.savefig('figures/engagement_per_clusters_' + str(index) + '.png')
	plt.close()
	...
	plt.savefig('figures/engagement_per_level_' + str(index) + '.png')
